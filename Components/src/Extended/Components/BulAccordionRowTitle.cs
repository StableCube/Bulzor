...
public class BulAccordionRowTitle : BulComponentBase
{
    ...
    protected BulmaClassBuilder RootBuilder { get; set; } = new BulmaClassBuilder("accordion-row-title");

    protected BulmaClassBuilder HeaderClassBuilder { get; set; } = new BulmaClassBuilder("accordion-row-header");

    protected BulmaClassBuilder ArrowClassBuilder { get; set; } = new BulmaClassBuilder("accordion-row-header-arrow");

    protected BulmaClassBuilder TitleClassBuilder { get; set; } = new BulmaClassBuilder("accordion-row-header-title");
    ...
    protected override void BuildBulma()
    {
        ...
        RootBuilder.SchemeColor = Color;

        MergeBuilderClassAttribute(RootBuilder);
    }
