...
public class BulImageRibbonItem : BulComponentBase
{
    ...
    protected BulmaClassBuilder RootClassBuilder = new("image-ribbon-item");
    protected BulmaClassBuilder WrapClassBuilder = new("image");
    protected BulmaClassBuilder ImageClassBuilder = new();
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        builder.AddContent(3, (builder2) =>
        {
            ...
            builder2.AddContent(6, (builder3) =>
            {
